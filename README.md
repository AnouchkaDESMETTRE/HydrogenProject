Global Overview of the notebooks :
- Hydrogen Gas and Metal-Oxide Solid Densities Equations
   - Absorption and Desorption Cases of Solid Density Equation in an Homogenous Reactor (analytical solution and numerical using DifferentialEquations.jl library): Section 2 of https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb
   - Absorption of the coupled densities in an Homogenous Reactor (numerical solution using DifferentialEquations.jl library): Section 3 of https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb
   - Steady state of Absorption of Gas Density equation in 1D (z axis) constant inlet Flow (analytical resolution and numerical using DifferentialEquations.jl library, Ferrite and Flemish Fish code)  : Section 4.1 of https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb
   - Transient model of Absorption of Gas Density equation in 1D (z axis) constant inlet Flow (analytical resolution and numerical using DifferentialEquations.jl library, Ferrite and Flemish Fish code)  : Section 4.2.1 of https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb
   - Transient model of Absorption of the coupled densities in 1D (z axis) constant inlet Flow (analytical resolution and numerical using DifferentialEquations.jl library, Ferrite)  : Section 4.2.2 of https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb
   -  Transient model of Absorption of the coupled densities in 2D with tank and nozzle geometry (numerical solution using Ferrite.jl) : https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/ferrite_2d_hydrogen_reactor.ipynb
  
- Study of Boundary conditions
   - Hand-Coded Linear Dirichlet Boundary Condition (solving the steady-state gas density absorption equation) : Section 1 http://localhost:8891/notebooks/Desktop/HydrogenProject/Understanding_BC_FEM.ipynb
   - Poisson Equation with constant source term  and Linear Scalar Diffusion in 2D simple rectangular mesh generated by Ferrite.jl (linear bc generated by dirichlet from ferrite, Mean Average Constraint and Penalty Method) : Scetion 2 https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/pressure-inlet-conditions.ipynb.
   - Poisson Equation with constant source term  and Non Linear Scalar Diffusion in 2D simple rectangular mesh generated by Ferrite.jl non-linear Dirichlet boundary condition on the left patch using Transient Penalty Method with Differential.jl : Section 3 https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/pressure-inlet-conditions.ipynb.

- Navier Stokes Equations
   - ??????
     
- Meshes
   - Rectangular Tank : https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/tank_mesh.ipynb
   - Rectangular Tank and Nozzle : https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/tankAndNozzle.ipynb
