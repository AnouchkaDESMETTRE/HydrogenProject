...
* **Homogeneous Reactor Models (0D):**
    ...
    * Coupled Densities Absorption (numerical with `DifferentialEquations.jl`): [Section 3 of `HydrogenProject.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb#section-3)

* **1D Absorption Models (Z-axis, analytical & numerical with `DifferentialEquations.jl`, `Ferrite.jl`, Flemish Fish code):**
    * Steady-State Gas Density Absorption (constant inlet flow): [Section 4.1 of `HydrogenProject.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb#section-4-1)
    * Transient Gas Density Absorption (constant inlet flow): [Section 4.2.1 of `HydrogenProject.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb#section-4-2-1)
    * Transient Coupled Densities Absorption (constant inlet flow): [Section 4.2.2 of `HydrogenProject.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/HydrogenProject.ipynb#section-4-2-2)
...
* **FEM for 1D Heat Equation (Simple Rectangular Mesh generated by `Ferrite.jl`):**
    * Non Linear Boundary Conditions With Accurate Solution at t=0 [Section 3 of `Understanding_BC_FEM.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/Understanding_BC_FEM.ipynb)
    * Linear Boundary Conditions Validation Code [Section 1  of `Heat_Equation.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/Heat_Equation.ipynb)
    * Non Linear Boundary Conditions Explicit and Implicit Solver (With Analytical Jacobian) Validation Code [Section 2 and 3 of `Heat_Equation.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/Heat_Equation.ipynb)

* **FEM for 2D Heat and Poisson Equation (Simple Rectangular Mesh generated by `Ferrite.jl`):**
    ...
    * Linear and Non Linear Boundary Conditions Implicit Solver (With Analytical Jacobian) Validation Code [Section 5 and 6 of `Heat_Equation.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/Heat_Equation.ipynb)

#### Navier-Stokes Equations Development

* **Previous Explorations & Challenges:**
    * 2D Channel Flow (Open/Closed): [`navier_stokes_2d_channel.ipynb`](https://github.com/ziolai/finite_element_electrical_engineering/blob/main/project-based-assignment/metal-hydride-storage/notebooks/navier_stokes_2d_channel.ipynb) (Issue: Problems with pressure boundary conditions).
