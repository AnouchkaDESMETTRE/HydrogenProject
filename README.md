...
* **FEM for 1D Heat Equation (Simple Rectangular Mesh generated by `Ferrite.jl`):**
    ...
    * Linear and Non Linear Boundary Conditions Validation Code [Section 2 and 3 of `Heat_Equation.ipynb`](https://github.com/AnouchkaDESMETTRE/HydrogenProject/blob/main/Heat_Equation.ipynb)
